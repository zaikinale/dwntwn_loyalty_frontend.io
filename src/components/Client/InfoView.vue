<template>
  ...
  <div class="rules-content">
    ...
    <p><strong>8. Изменение правил</strong><br />Мы оставляем за собой право изменять условия программы. Все изменения вступают в силу через 10 дней после публикации в Telegram-боте @dwntwn_coffee_support_bot.</p>
  </div>
</div>
