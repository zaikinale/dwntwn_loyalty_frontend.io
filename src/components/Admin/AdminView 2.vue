...
const addNotification = async () => {
  ...
  try {
    ...
    const url = `${window.API_BASE}/api/admin/notification?admin_id=${adminId.value}&type=${encodeURIComponent(type)}&title=${encodeURIComponent(title)}&description=${encodeURIComponent(description)}&days_valid=${days}`
